...
<html>
    ...
    <body>
        ...
        <div class = "menuBar">
            <div id = "menu_position">
                <div style = "display: flex; align-items:center">
                    <img id = "logoedX" src = "{{ asset('images/logo.png') }}"   style = "max-width: 5%; height: auto; ">
                    <button  id = "menuButton_1" >Courses</button>
                    <button  id = "menuButton_2" >Schools & Partners</button>
                    <a id ="menu3" href = " {{ asset('html/office.html') }}"><button  id = "menuButton_3" >Branch Office</button></a>
                </div>
                <div style = "display: flex; align-items:center">
                    <a href = "registretion.html"><button id = "login">Login</button></a>
                </div>
            </div>
            <!-- Course(btn) infrmation -->
            <div class = "course_inf">
                <div id = "course_inf_text">
                    <p style="font-size: 20px; color:#00008B; font-size: 1.5vw;">Courses by Subject</p>
                    <hr>
                ...
                <div id = "course_inf_text_2">
                    <p style = "font-size: 1.5vw; color:#00008B">University</p>
                    <hr>
                    <div id = "course_conteiner">
                        <div id = "course_conteiner_1">
        ...
        <div class = "menu_image">
            <div id = "first_glance">
                <p id = "text_inf" >Access 2500+ Online Courses <br> from 140 Institution. Start Today!</p>  
                <img id = "girl_image" src = "{{ asset('images/girls2.jpg') }} " alt = "Error"  height = "100%">
            </div>
        </div>
        <!-- Search input line -->
        ...
        <div class = "university">
            <a href = "https://www.bu.edu/"><img id = "boston" src = "{{ asset('images/boston.jpg') }}" width="80px" height="35px"></a>
            <a href = "https://www.harvard.edu/"><img id = "harward" src = "{{ asset('images/harward.png') }}" width="140px" height="80px"></a>
            <a href = "https://www.hku.hk/"><img id = "hongHong" src = "{{ asset('images/HongKong.png') }}" width="120px" height="130px"></a>
            <a href = "https://sdu.edu.kz/"><img id = "sdu" src = "{{ asset('images/sdu.png') }}" width="110px" height="110px"></a>
            <a href = "https://www.massachusetts.edu/"><img id = "massachusetts" src = "{{ asset('images/massachusetts.jpg') }}" width="90px" height="70px"></a>
            <a href = "https://www.cam.ac.uk/"><img id = "berkeley" src = "{{ asset('images/berkeleylogo.jpg') }}" width="120px" height="35px"></a>
        </div>
        <!-- Advertising -->
        <div class = "TA">
            <div id = "TA_inf">
                <p id = "TA_text_inf"><strong>Executive Education Course on <br>Business Analytics Fundamentals <br> for Leaders</strong></p>
                <p id = "Ta_text_inf_2">A 4-week foundational course for those looking to be able to analyze, present findings, and <br>make meaningful conclusions about data in a business setting.</p>
                <a href = "{{ asset('html/ta.html') }}"><button id = "TA_button">Information</button></a>
            </div>
            <img id = "TA_img" src = "{{ asset('images/photo_2020-11-21_13-58-40.jpg') }}" width="40%" height="100%">
        </div>
        <!-- Subject -->
        <div class = "Subject">
            <p id = "Subject_text"><strong>Popular Subjects</strong></p>
            <div id = "Subject_block_1">
                <div id = "Block">
                    <div id = "Line_1">
                        ...
                        <p id = "Line_1_text" ><strong>Computer Science</strong></p>
                    </div>
                    <div id = "Line_2">
                        <ul >
                            ...
                            <li><a id = "course_text" href="{{ asset('html/java.html') }}" >Java</a></li>
                ...
                <div id = "Block">
                    <div id = "Line_1">
                        ...
                        <p id = "Line_1_text"><strong>Language</strong></p>
                    </div>
                    <div id ="Line_2">
                        <ul>
                ...
                <div id = "Block">
                    <div id = "Line_1">
                        ...
                        <p id = "Line_1_text" ><strong>Data Science</strong></p>
                    </div>
                    <div id = "Line_2">
                        <ul>
            ...
            <div id = "Subject_block_1">
                <div id = "Block">
                    <div id = "Line_1">
                        ...
                        <p id = "Line_1_text"><strong>Business & Managment</strong></p>
                    </div>
                    <div id = "Line_2">
                        <ul >
                ...
                <div id = "Block">
                    <div id = "Line_1">
                        ...
                        <p id = "Line_1_text"><strong>Engineering</strong></p>
                    </div>
                    <div id = "Line_2">
                        <ul>
                ...
                <div id = "Block">
                    <div id = "Line_1">
                        ...
                        <p id = "Line_1_text"><strong>Humanities</strong></p>
                    </div>
                    <div id = "Line_2">
                        <ul >
        ...
        <div class = "Contact_edX">
            <div id = "edX_inf">
                <img id ="edX_logo" src = "{{ asset('images/logo.png') }}"  height="35px">
